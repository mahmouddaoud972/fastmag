...
<meta name="title" content="acompte" />
...
<script nonce="6d0075f3" async src="/javascript.js.php?website=<?php echo $websitekey; ?>"></script>
...
<body id="bodywebsite" class="bodywebsite bodywebpage-acompte">
<?php
...
if ($db) {
    ...
    $sql = "SELECT f.rowid AS facture_id, f.ref, f.datec, f.date_lim_reglement, f.total_ht, f.total_tva, f.total_ttc, f.multicurrency_total_ttc, f.fk_statut,f.type,f.paye, 
            ...
            WHERE f.fk_soc = " . intval($societe_id) . " AND f.ref LIKE 'AC%'";
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 181); dolWebsiteIncrementCounter(9, "page", 181);
// END PHP ?>
