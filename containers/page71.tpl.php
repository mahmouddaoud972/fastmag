...
<meta name="dolibarr:pageid" content="71" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                <img src="image/Zai.tn/team/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg" class="img-fluid team-image" alt="">
                        ...
                        <div class="col-lg-4 col-12 my-lg-0 my-4">
                            <div class="team-thumb">
                                <img src="image/Zai.tn/team/nicolas-horn-MTZTGvDsHFY-unsplash.jpg" class="img-fluid team-image" alt="">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                <img src="image/Zai.tn/team/rc-cf-FMh5o5m5N9E-unsplash.jpg" class="img-fluid team-image" alt="">
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 71); dolWebsiteIncrementCounter(9, "page", 71);
// END PHP ?>
