...
<meta name="dolibarr:pageid" content="81" />
...
$fixedHours = "08:00 PM To 06:00 AM";

foreach ($days as $day) {
    echo "<p>$day : $fixedHours</p>";
}
?>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 81); dolWebsiteIncrementCounter(9, "other", 81);
// END PHP ?>
