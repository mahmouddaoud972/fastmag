...
<meta name="dolibarr:pageid" content="87" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="image/Zai.tn/slide/Compte-Pro-Logiciel-de-caisse.jpg"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="image/Zai.tn/lunch/louis-hansel-rheOvfxOlOA-unsplash.jpg"
                                    class="img-fluid menu-image"
                                    alt=""
                                />
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 87); dolWebsiteIncrementCounter(9, "page", 87);
// END PHP ?>
