...
<meta name="dolibarr:pageid" content="83" />
...
<script nonce="e4d6dbde" async src="/javascript.js.php?website=<?php echo $websitekey; ?>"></script>
...
if ($db) {
    ...
    if (!empty($filter_statut)) {
        if ($filter_statut == '1') {
            ...
            $sql .= " AND f.fk_statut = 2 AND f.paye = 1 AND f.type = 3 OR f.type = 3";
        }
        
        // elseif ($filter_statut == '4') {
        //     $sql .= " AND f.fk_statut = 2 AND f.paye = 1 AND (f.type = 3 OR f.type NOT IN (0, 2, 3))";
        // }
...
$link_to_page = dol_buildpath('facture.php', 1);
?>
                            ...
                            <th style="position: relative;">
                                <div class="filter-statut">
                                    <form action="<?php echo htmlspecialchars($link_to_page); ?>" method="get">
                                        <input type="hidden" name="website" value="ZaiPortal">
                    ...
                    <tbody>
                        ...
                        if ($result) {
                            while ($row = $db->fetch_object($result)) {
                                ...
                                } elseif ($row->fk_statut == 2 && $row->paye == 1) {
                                    echo "<td>Payé</td>";
                                }
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 83); dolWebsiteIncrementCounter(9, "page", 83);
// END PHP ?>
