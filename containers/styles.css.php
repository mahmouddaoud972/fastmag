...
.oorder-table {
    ...
    .oorder-table tbody tr:nth-child(even) {
        background-color: #f3f3f3 ;
    }
    
    .oorder-table td {
        border-bottom: 1px solid #263c5c69;
    }
...
.bodywebsite .site-about-header {
    background-image: url("/viewimage.php?modulepart=medias&file=image/Zai.tn/slide/Compte-Pro-Logiciel-de-caisse.jpg");
}
...
.bodywebsite .site-footer::before {
    content: "";
    background: linear-gradient(to top, #a9a9a921, transparent 200%);
    position: absolute;
    top: 0;
    right: 0;
    bottom: 0;
...
.bodywebsite .navbar.customLayer {
  background: var(--color-first);
}
<?php // BEGIN PHP
